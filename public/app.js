...
function renderHouseholdChart(data) {
  const percentages = data.percentages || { privateToilet: 82.7, vehicle: 78.6, tapWater: 40.8, cleanEnergy: 57.1, ownHouse: 90.8, aadhaar: 100 };
...
const translationDictionary = {
  hi: {
    ...
    '#about-history-p1': '<strong>इतिहास:</strong> सीतारामपुरम टांडा की स्थापना कई पीढ़ियों पहले बंजारा (लंबाडी) जनजाति के परिवारों द्वारा की गई थी, जो आंध्र प्रदेश के वर्तमान NTR जिले के क्षेत्र में चले गए थे। एक अस्थायी बस्ती (टांडा) के रूप में शुरू होकर, यह धीरे-धीरे एक स्थायी और लचीले कृषि समुदाय के रूप में विकसित हुआ।',
    '#about-history-p2': '<strong>नामकरण उत्पत्ति:</strong> "सीतारामपुरम" नाम बस्ती के पास स्थित ऐतिहासिक सीताराम मंदिर से लिया गया है, जहां समुदाय आज भी पूजा करता है। प्रत्यय "टांडा" बंजारा बस्ती का पारंपरिक शब्द है।',
    '#about-history-p3': '<strong>आदिवासी पहचान और संस्कृति:</strong> यह गाँव मुख्य रूप से लंबाडी समुदाय द्वारा बसा हुआ है, जो अपनी पैतृक आदतों, पारंपरिक रंग-बिरंगी कशीदाकारी पोशाक (दर्पण और कौड़ियों से सजी) को संरक्षित करते हैं, और तीज जैसे त्योहारों के दौरान लोक नृत्य और गीत प्रस्तुत करते हैं।',
    '#about-history-p4': '<strong>भूगोल और भाषा:</strong> आंध्र प्रदेश के NTR जिले के मायलावरम मंडल में पुल्लूरु के पास स्थित, हमारे निवासी आपस में गोर बोली (मूल लंबाडी बोली) बोलते हैं, और बाहरी संचार और व्यापार के लिए तेलुगु या हिंदी का उपयोग करते हैं। नजदीकी शहर मायलावरम (7 किमी) और विजयवाड़ा (25 किमी) हैं।',
    ...
    '#edu-desc-higher': 'वर्तमान में, गाँव के 28 छात्र मायलावरम और आस-पास के कॉलेज में उच्च शिक्षा प्राप्त कर रहे हैं। उन्हें ग्राम पंचायत से यात्रा पास सब्सिडी मिलती है।',
    ...
    '#health-facility-desc-phc': 'मायलावरम मंडल अस्पताल (7 किमी)',
  ...
  te: {
    ...
    '#about-history-p1': '<strong>చరిత్ర:</strong> సీతారామపురం తండా కొన్ని తరాల క్రితం ఆంధ్రప్రదేశ్‌లోని ప్రస్తుత NTR జిల్లా ప్రాంతానికి వలస వచ్చిన బంజారా (లంబాడీ) గిరిజన కుటుంబాల ద్వారా ఏర్పడింది. ఒక తాత్కాలిక నివాస ప్రాంతం (తండా)గా ప్రారంభమై, ఇది క్రమంగా శాశ్వత మరియు స్థితిస్థాపక వ్యవసాయ సమాజంగా అభివృద్ధి చెందింది.',
    '#about-history-p2': '<strong>పేరు వెనుక చరిత్ర:</strong> ఈ నివాస ప్రాంతానికి సమీపంలో ఉన్న చారిత్రాత్మక సీతారామ ఆలయం నుండి "సీతారామపురం" అనే పేరు వచ్చింది, ఇక్కడ సమాజం నేటికీ ప్రార్థనలు నిర్వహిస్తూనే ఉంది. "తండా" అనేది బంజారా స్థావరానికి ఉపయోగించే సాంప్రదాయ పదం.',
    '#about-history-p3': '<strong>గిరిజన గుర్తింపు & సంస్కృతి:</strong> ఈ గ్రామంలో ప్రధానంగా లంబాడీ సమాజం నివసిస్తుంది, వీరు తమ పూర్వీకుల ఆచారాలను, సాంప్రదాయ అద్దాలు మరియు కౌరీ షెల్స్ కలిగిన రంగురంగుల దుస్తులను కాపాడుకుంటున్నారు మరియు తీజ్ వంటి పండుగల సమయంలో జానపద నృత్యాలు మరియు పాటలను ప్రదర్శిస్తారు.',
    '#about-history-p4': '<strong>భౌగోళికం & భాష:</strong> ఆంధ్రప్రదేశ్‌లోని NTR జిల్లా, మైలవరం మండలం పుల్లూరు సమీపంలో ఉన్న ఈ తండా నివాసితులు అంతర్గతంగా గోర్ బోలి (లంబాడీ భాష) మాట్లాడతారు, మరియు బాహ్య సమాచారం మరియు వ్యాపారం కొరకు తెలుగు లేదా హిందీ ఉపయోగిస్తారు. సమీప పట్టణాలు మైలవరం (7 కి.మీ) మరియు విజయవాడ (25 కి.మీ).',
    ...
    '#edu-desc-higher': 'ప్రస్తుతం, గ్రామానికి చెందిన 28 మంది విద్యార్థులు మైలవరం మరియు సమీప కాలేజీలలో ఉన్నత విద్యను అభ్యసిస్తున్నారు. వీరికి గ్రామ పంచాయతీ నుండి రవాణా రాయితీ అందుతోంది.',
    ...
    '#health-facility-desc-phc': 'మైలవరం మండల ఆసుపత్రి (7 కి.మీ)',
